...
int SymbolTable::getM(Scope scope) const {
	int n = _records[scope]._len; // êîëè÷åñòâî àðãóìåíòîâ ôóíêöèè
	int m = 0;                    // Èñêîìîå M - êîëè÷åñòâî ëîêàëüíûõ è âðåìåííûõ ïåðåìåííûõ
	int vars = 0;                 // êîëè÷åñòâî ïåðåìåííûõ â scope
